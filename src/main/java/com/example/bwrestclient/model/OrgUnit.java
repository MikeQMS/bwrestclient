...
public class OrgUnit implements Serializable
{
    ...
    private final static long serialVersionUID = 7272915406672257839L;
    ...
    public String toString() {
        ...
        sb.append(OrgUnit.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OrgUnit) == false) {
            return false;
        }
        OrgUnit rhs = ((OrgUnit) other);
