...
public class WorkingTime implements Serializable
{
    ...
    private final static long serialVersionUID = -7633862891669222236L;
     ...
     * @param id
     */
    public WorkingTime(Integer id, String internalName, String name) {
        super();
        this.id = id;
    ...
    public String toString() {
        ...
        sb.append(WorkingTime.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WorkingTime) == false) {
            return false;
        }
        WorkingTime rhs = ((WorkingTime) other);
